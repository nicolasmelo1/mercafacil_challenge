 ...
 */
async function createPalmaresMigrationsTableAndGetLastMigrationName(engineInstance, internalModelsByModelName) {
    ...
    const createPalmaresMigrationsTable = async (transaction) => {
