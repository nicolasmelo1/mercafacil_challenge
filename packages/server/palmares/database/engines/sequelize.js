...
class SequelizeEngine extends Engine {
    ...
    /**
     * Used for testing if the database is connected or not. If the database is connected just continue whatever you are doing.
    ...
    /**
     * Retrieves if the database is connected or not
     * 
     * @returns {boolean} - Is the database connected or is it not connected
     */
    isConnected() {
